    ...
    $(document).ready(function () {
        ...
        let termsObj = {
            ...
            termElement6: {
                ...
                termOptions: [
                    'Выбрать все',
                    'Низкий (не хватает денег на одежду, еду, оплату жилья) – отсев',
        ...
        function addQuestion(type, appendInde, id) {
            ...
            let topEL =
                ...
                <div class="display-checked-terms">Here will be checked terms ${termIndex}</div>
                ${terms}
                ${nameHtml}`;
            let el;
        ...
        $('.constr-wrap').on('change', '.term-el', function () {
            let termIndex = $(this).parents('.terms-main-menu').attr('data-index');
            console.log(termIndex)
            for (let [index, value] of Object.values(termsObj).entries()) {
                console.log(index, value.selectedtermOptions);
